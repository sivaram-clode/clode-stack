...
//
// toolkit-proxy points COMPOSIO_BASE_URL at http://ec2mock:8080/composio; its
...
func New() *Handler {
	publicURL := strings.TrimRight(envOr("COMPOSIO_MOCK_PUBLIC_URL", "http://ec2mock.localhost:8080/composio"), "/")
